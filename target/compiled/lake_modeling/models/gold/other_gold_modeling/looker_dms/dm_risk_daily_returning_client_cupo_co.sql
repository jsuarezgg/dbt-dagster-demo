...
data_score_addicupo as (
  ...
  from      risk.daily_client_data_co AS a
  ...
  left join gold.dm_risk_daily_client_data_lastest_available_rc_model_score_co AS b on a.client_id = b.client_id and a.calculation_date = b.daily_client_data_calculation_date
),
