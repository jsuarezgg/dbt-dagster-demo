...
LEFT JOIN silver.f_client_management_credit_contracts_co cc on ls.loan_id = cc.loan_id
...
SELECT
    ...
    learning_population,
    fga,
    loan_lead_gen_fee_rate AS affiliate_fee, --How do we get this by suborder?
