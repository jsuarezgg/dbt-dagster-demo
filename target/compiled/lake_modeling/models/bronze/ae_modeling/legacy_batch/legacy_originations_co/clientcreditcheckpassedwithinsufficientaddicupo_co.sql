...
SELECT
    ...
    json_tmp.creditScore.value as credit_score,
    ...
    --json_tmp.loanProposals.npvEvaluationChargeOffRate.value as probability_default_addi,
    --json_tmp.loanProposals.expectedChargeoffRate as probability_default_bureau,
    json_tmp.storeFraudRiskLevel as store_fraud_risk_level,
    json_tmp.totalDebtToServiceRatio as tdsr,
    -- CUSTOM ATTRIBUTES
    'V1' as custom_idv_version
      -- Fill with your custom attributes
-- DBT SOURCE REFERENCE
from raw_modeling.clientcreditcheckpassedwithinsufficientaddicupo_co
