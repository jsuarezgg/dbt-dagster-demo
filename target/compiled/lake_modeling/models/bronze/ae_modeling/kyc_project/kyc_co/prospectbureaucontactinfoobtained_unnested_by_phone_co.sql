...
SELECT
    ...
    -- ITEM INNER FIELDS
    item.city AS bureau_phone_city,
    TO_TIMESTAMP(item.firstReport) AS bureau_phone_firstReport,
    item.isActive AS bureau_phone_isActive,
    TO_TIMESTAMP(item.lastReport) AS bureau_phone_lastReport,
    item.number AS bureau_phone_number,
    item.order AS bureau_phone_order,
    item.prefix AS bureau_phone_prefix,
    item.sector AS bureau_phone_sector,
    item.timesReported AS bureau_phone_timesReported
