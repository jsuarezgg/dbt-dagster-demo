...
--raw_modeling.preapprovalcreditcheckpassedpagoco_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS preapprovalcreditcheckpassedpagoco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from raw_modeling.preapprovalcreditcheckpassedpagoco_co
