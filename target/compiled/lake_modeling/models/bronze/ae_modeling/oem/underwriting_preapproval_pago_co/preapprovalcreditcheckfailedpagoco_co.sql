...
--raw_modeling.preapprovalcreditcheckfailedpagoco_co
SELECT
    -- MANDATORY FIELDS
    ...
    coalesce(json_tmp.creditCheck.lowBalanceLoan,
             json_tmp.creditCheck.lowBalanceLoanV2) as lbl,
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS preapprovalcreditcheckfailedpagoco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from raw_modeling.preapprovalcreditcheckfailedpagoco_co
