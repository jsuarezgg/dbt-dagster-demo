...
SELECT
    ...
    'REQUESTED' AS identity_photos_tp_custom_last_status,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartyrequested_co_at,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartyrequested_at
-- DBT SOURCE REFERENCE
from raw_modeling.identityphotosthirdpartyrequested_co
