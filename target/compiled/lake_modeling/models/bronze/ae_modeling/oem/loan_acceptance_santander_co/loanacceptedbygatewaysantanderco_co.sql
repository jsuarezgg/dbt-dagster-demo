...
--raw_modeling.loanacceptedbygatewaysantanderco_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.loan.originationDate as origination_date,
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS loanacceptedbygatewaysantanderco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from raw_modeling.loanacceptedbygatewaysantanderco_co
