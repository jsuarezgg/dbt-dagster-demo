...
, union_all_events AS (
    ...
    event_id
    FROM silver.f_applications_order_details_co  
    WHERE 
    silver.f_applications_order_details_co.application_id IN (SELECT DISTINCT application_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_applications_order_details_co
country: co
silver_table_name: f_applications_order_details_co
