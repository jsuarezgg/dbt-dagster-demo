...
, union_bronze AS (
    SELECT 
        ally_slug,NULL as application_channel_legacy,NULL as application_date,application_id,NULL as campaign_id,channel,NULL as client_checkout_type,client_id,client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_platform_version,journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,NULL as store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM allyisdisabledtooriginatebr_br
    UNION ALL
    SELECT 
        ally_slug,NULL as application_channel_legacy,application_date,application_id,NULL as campaign_id,channel,client_checkout_type,client_id,client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,custom_platform_version,journey_name,ocurred_on,order_id,order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,product,requested_amount,requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    ...
    UNION ALL
    SELECT 
        ally_slug,application_channel_legacy,application_date,application_id,NULL as campaign_id,NULL as channel,NULL as client_checkout_type,client_id,NULL as client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,custom_is_returning_client_legacy,custom_platform_version,NULL as journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,requested_amount,NULL as requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    ...
    UNION ALL
    SELECT 
        NULL as ally_slug,NULL as application_channel_legacy,NULL as application_date,application_id,campaign_id,NULL as channel,NULL as client_checkout_type,NULL as client_id,NULL as client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_platform_version,NULL as journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,NULL as store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    ...
    UNION ALL
    SELECT 
        ally_slug,NULL as application_channel_legacy,NULL as application_date,application_id,NULL as campaign_id,channel,NULL as client_checkout_type,client_id,client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_platform_version,journey_name,ocurred_on,NULL as order_id,NULL as order_type,preapproval_amount,preapproval_expiration_date,product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,NULL as store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    ...
    UNION ALL
    SELECT 
        ally_slug,application_channel_legacy,NULL as application_date,application_id,NULL as campaign_id,NULL as channel,NULL as client_checkout_type,client_id,NULL as client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_platform_version,NULL as journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,requested_amount,NULL as requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM privacypolicyaccepted_br
    UNION ALL
    SELECT 
        ally_slug,NULL as application_channel_legacy,NULL as application_date,application_id,campaign_id,channel,NULL as client_checkout_type,client_id,client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_platform_version,journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,NULL as store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM privacypolicyacceptedbr_br
    UNION ALL
    SELECT 
        ally_slug,NULL as application_channel_legacy,NULL as application_date,application_id,NULL as campaign_id,NULL as channel,NULL as client_checkout_type,client_id,NULL as client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,custom_platform_version,NULL as journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,NULL as requested_amount,NULL as requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM privacypolicysent_br
    UNION ALL
    SELECT 
        ally_slug,application_channel_legacy,application_date,application_id,NULL as campaign_id,NULL as channel,NULL as client_checkout_type,client_id,NULL as client_type,NULL as custom_is_bnpn_branched,custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,custom_platform_version,NULL as journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,requested_amount,NULL as requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM prospectloanapplicationcreatedfromcheckpoint_br
    UNION ALL
    SELECT 
        ally_slug,application_channel_legacy,application_date,application_id,NULL as campaign_id,NULL as channel,NULL as client_checkout_type,client_id,NULL as client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,custom_platform_version,NULL as journey_name,ocurred_on,order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,requested_amount,NULL as requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM prospectloanapplicationcreatedv2_br
    UNION ALL
    SELECT 
        NULL as ally_slug,NULL as application_channel_legacy,NULL as application_date,application_id,NULL as campaign_id,NULL as channel,NULL as client_checkout_type,NULL as client_id,NULL as client_type,NULL as custom_is_bnpn_branched,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_platform_version,NULL as journey_name,ocurred_on,NULL as order_id,NULL as order_type,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
...
, union_all_events AS (
    SELECT 
    ally_slug,application_channel_legacy,application_date,application_id,campaign_id,channel,client_checkout_type,client_id,client_type,custom_is_bnpn_branched,custom_is_checkpoint_application_legacy,custom_is_preapproval_completed,custom_is_privacy_policy_accepted,custom_is_returning_client_legacy,custom_platform_version,journey_name,ocurred_on,order_id,order_type,preapproval_amount,preapproval_expiration_date,product,requested_amount,requested_amount_without_discount,store_slug,store_user_id,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM union_bronze 
    UNION ALL
    SELECT 
    ally_slug,application_channel_legacy,application_date,application_id,campaign_id,channel,client_checkout_type,client_id,client_type,custom_is_bnpn_branched,custom_is_checkpoint_application_legacy,custom_is_preapproval_completed,custom_is_privacy_policy_accepted,custom_is_returning_client_legacy,custom_platform_version,journey_name,last_event_ocurred_on_processed as ocurred_on,order_id,order_type,preapproval_amount,preapproval_expiration_date,product,requested_amount,requested_amount_without_discount,store_slug,store_user_id,last_event_name_processed,
    event_name,last_event_id_processed,
    event_id
    FROM silver.f_applications_br  
    WHERE 
    silver.f_applications_br.application_id IN (SELECT DISTINCT application_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_applications_br
country: br
silver_table_name: f_applications_br
table_pk_fields: ['application_id']
table_pk_amount: 1
fields_direct: ['ally_slug', 'application_channel_legacy', 'application_date', 'application_id', 'campaign_id', 'channel', 'client_checkout_type', 'client_id', 'client_type', 'custom_is_bnpn_branched', 'custom_is_checkpoint_application_legacy', 'custom_is_preapproval_completed', 'custom_is_privacy_policy_accepted', 'custom_is_returning_client_legacy', 'custom_platform_version', 'journey_name', 'ocurred_on', 'order_id', 'order_type', 'preapproval_amount', 'preapproval_expiration_date', 'product', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id']
mandatory_fields: ['event_name', 'event_id']
events_dict: {'allyisdisabledtooriginatebr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'applicationcreated': {'direct_attributes': ['application_id', 'ally_slug', 'application_date', 'channel', 'client_checkout_type', 'client_id', 'client_type', 'custom_platform_version', 'journey_name', 'order_id', 'order_type', 'product', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'backgroundcheckpassedbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'checkoutloginsentbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'clientloanapplicationcreated': {'direct_attributes': ['application_id', 'ally_slug', 'application_date', 'application_channel_legacy', 'client_id', 'custom_is_returning_client_legacy', 'custom_platform_version', 'requested_amount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'clientpreapprovaljourneyisdisabledbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'clientwaspreapprovedbeforebr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'loanproposalselectedbr': {'direct_attributes': ['application_id', 'campaign_id', 'ocurred_on'], 'custom_attributes': {}}, 'pixpaymentrequestedbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'custom_is_bnpn_branched', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'preapprovalapplicationcompletedbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'custom_is_preapproval_completed', 'journey_name', 'preapproval_amount', 'preapproval_expiration_date', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'preconditionswerevalidbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyaccepted': {'direct_attributes': ['application_id', 'ally_slug', 'application_channel_legacy', 'client_id', 'custom_is_privacy_policy_accepted', 'requested_amount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyacceptedbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'campaign_id', 'client_id', 'client_type', 'custom_is_privacy_policy_accepted', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicysent': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'custom_platform_version', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'prospectloanapplicationcreatedfromcheckpoint': {'direct_attributes': ['application_id', 'ally_slug', 'application_date', 'application_channel_legacy', 'client_id', 'custom_is_checkpoint_application_legacy', 'custom_platform_version', 'requested_amount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'prospectloanapplicationcreatedv2': {'direct_attributes': ['application_id', 'ally_slug', 'application_date', 'application_channel_legacy', 'client_id', 'custom_platform_version', 'order_id', 'requested_amount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'prospectupgradedtoclient': {'direct_attributes': ['application_id', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwasgreaterthanmaximumconfiguredbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwaslessthanminimumconfiguredbr': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'backgroundcheckpassed': {'direct_attributes': ['application_id', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}}
events_keys: ['allyisdisabledtooriginatebr', 'applicationcreated', 'backgroundcheckpassedbr', 'checkoutloginsentbr', 'clientloanapplicationcreated', 'clientpreapprovaljourneyisdisabledbr', 'clientwaspreapprovedbeforebr', 'loanproposalselectedbr', 'pixpaymentrequestedbr', 'preapprovalapplicationcompletedbr', 'preconditionswerevalidbr', 'privacypolicyaccepted', 'privacypolicyacceptedbr', 'privacypolicysent', 'prospectloanapplicationcreatedfromcheckpoint', 'prospectloanapplicationcreatedv2', 'prospectupgradedtoclient', 'requestedamountwasgreaterthanmaximumconfiguredbr', 'requestedamountwaslessthanminimumconfiguredbr', 'backgroundcheckpassed']
