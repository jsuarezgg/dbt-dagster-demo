...
, union_bronze AS (
    ...
    UNION ALL
    SELECT 
        ally_slug,NULL as application_cellphone,NULL as application_channel_legacy,NULL as application_date,application_email,application_id,NULL as campaign_id,NULL as channel,client_id,NULL as client_is_transactional_based,NULL as client_type,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_is_santander_branched,NULL as custom_platform_version,NULL as id_number,NULL as id_type,NULL as journey_name,ocurred_on,NULL as order_id,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,store_user_id,NULL as store_user_name,
    event_name,
    event_id
    ...
    UNION ALL
    SELECT 
        NULL as ally_slug,application_cellphone,NULL as application_channel_legacy,NULL as application_date,application_email,application_id,NULL as campaign_id,NULL as channel,NULL as client_id,NULL as client_is_transactional_based,NULL as client_type,NULL as custom_is_checkpoint_application_legacy,NULL as custom_is_preapproval_completed,NULL as custom_is_privacy_policy_accepted,NULL as custom_is_returning_client_legacy,NULL as custom_is_santander_branched,NULL as custom_platform_version,NULL as id_number,NULL as id_type,NULL as journey_name,ocurred_on,NULL as order_id,NULL as preapproval_amount,NULL as preapproval_expiration_date,NULL as product,NULL as requested_amount,NULL as requested_amount_without_discount,NULL as store_slug,NULL as store_user_id,NULL as store_user_name,
    event_name,
    event_id
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_pii_applications_co_logs
country: co
silver_table_name: f_pii_applications_co_logs
table_pk_fields: ['event_id']
table_pk_amount: 1
fields_direct: ['ally_slug', 'application_cellphone', 'application_channel_legacy', 'application_date', 'application_email', 'application_id', 'campaign_id', 'channel', 'client_id', 'client_is_transactional_based', 'client_type', 'custom_is_checkpoint_application_legacy', 'custom_is_preapproval_completed', 'custom_is_privacy_policy_accepted', 'custom_is_returning_client_legacy', 'custom_is_santander_branched', 'custom_platform_version', 'event_id', 'id_number', 'id_type', 'journey_name', 'ocurred_on', 'order_id', 'preapproval_amount', 'preapproval_expiration_date', 'product', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name']
mandatory_fields: ['event_name', 'event_id']
events_dict: {'allyapplicationupdated': {'direct_attributes': ['application_id', 'ally_slug', 'event_id', 'client_id', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'allyisdisabledtooriginateco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'allyisdisabledtooriginatepagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'applicationcreated': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_date', 'application_email', 'event_id', 'channel', 'client_id', 'client_is_transactional_based', 'client_type', 'custom_platform_version', 'id_number', 'id_type', 'order_id', 'product', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'backgroundcheckpassedco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'channel', 'client_id', 'client_type', 'event_id', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'checkoutloginsentco': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'event_id', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'clientloanapplicationcreated': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_date', 'application_email', 'event_id', 'client_id', 'custom_is_returning_client_legacy', 'custom_platform_version', 'id_number', 'id_type', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'clientpreapprovaljourneyisdisabledpagoco': {'direct_attributes': ['application_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'clientwaspreapprovedbeforepagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'creditcheckapprovedsantanderco': {'direct_attributes': ['application_id', 'event_id', 'custom_is_santander_branched', 'ocurred_on'], 'custom_attributes': {}}, 'leaddisabledtooriginateco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'leaddisabledtooriginatepagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'loanproposalselectedco': {'direct_attributes': ['application_id', 'campaign_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'loanproposalselectedsantanderco': {'direct_attributes': ['application_id', 'campaign_id', 'event_id', 'custom_is_santander_branched', 'ocurred_on'], 'custom_attributes': {}}, 'preapprovalapplicationcompletedco': {'direct_attributes': ['application_id', 'event_id', 'custom_is_preapproval_completed', 'preapproval_amount', 'preapproval_expiration_date', 'ocurred_on'], 'custom_attributes': {}}, 'preconditionswerevalidco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'preconditionswerevalidpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyaccepted': {'direct_attributes': ['application_id', 'application_cellphone', 'application_date', 'application_email', 'event_id', 'client_id', 'custom_is_privacy_policy_accepted', 'id_number', 'id_type', 'requested_amount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyacceptedco': {'direct_attributes': ['application_id', 'application_cellphone', 'application_email', 'event_id', 'campaign_id', 'client_id', 'custom_is_privacy_policy_accepted', 'id_number', 'id_type', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyacceptedsantanderco': {'direct_attributes': ['application_id', 'application_cellphone', 'application_email', 'event_id', 'campaign_id', 'client_id', 'id_number', 'id_type', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicysent': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_date', 'custom_platform_version', 'event_id', 'client_id', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'prospectapplicationpreapproved': {'direct_attributes': ['application_id', 'custom_is_preapproval_completed', 'event_id', 'preapproval_amount', 'preapproval_expiration_date', 'ocurred_on'], 'custom_attributes': {}}, 'prospectloanapplicationcreatedfromcheckpoint': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_channel_legacy', 'application_date', 'application_email', 'event_id', 'client_id', 'custom_is_checkpoint_application_legacy', 'custom_is_preapproval_completed', 'custom_platform_version', 'id_number', 'id_type', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'prospectloanapplicationcreatedv2': {'direct_attributes': ['application_id', 'ally_slug', 'application_channel_legacy', 'application_date', 'event_id', 'client_id', 'custom_platform_version', 'order_id', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'prospectupgradedtoclient': {'direct_attributes': ['application_id', 'ally_slug', 'application_email', 'client_id', 'event_id', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwasgreaterthanmaximumconfiguredco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwasgreaterthanmaximumconfiguredpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwaslessthanminimumconfiguredco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwaslessthanminimumconfiguredpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'returningclientjourneyisdisableco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'event_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'cellphonealreadylinkedtoadifferentprospectco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'cellphonealreadylinkedtoexistingclientco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'cellphonelistedinblacklistco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'documentlistedinblacklistco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'emailalreadylinkedtoexistingclientco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'failedtovalidateemailco': {'direct_attributes': ['application_id', 'ally_slug', 'application_cellphone', 'application_email', 'client_id', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'invalidemailco': {'direct_attributes': ['application_id', 'application_cellphone', 'application_email', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'listedinofacco': {'direct_attributes': ['application_id', 'application_cellphone', 'application_email', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'prospectalreadylinkedtodifferentcellphoneco': {'direct_attributes': ['application_id', 'application_cellphone', 'application_email', 'event_id', 'ocurred_on'], 'custom_attributes': {}}, 'backgroundcheckpassed': {'direct_attributes': ['application_id', 'event_id', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}}
