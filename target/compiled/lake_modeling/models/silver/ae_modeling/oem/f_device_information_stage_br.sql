...
, union_all_events AS (
    ...
    event_id
    FROM silver.f_device_information_stage_br  
    WHERE 
    silver.f_device_information_stage_br.application_id IN (SELECT DISTINCT application_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_device_information_stage_br
country: br
silver_table_name: f_device_information_stage_br
