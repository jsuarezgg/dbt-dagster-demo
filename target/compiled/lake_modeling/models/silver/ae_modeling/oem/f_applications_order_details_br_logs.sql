...
WITH
applicationcreated_unnested_by_items_br AS ( 
    SELECT *
    FROM bronze.applicationcreated_unnested_by_items_br
...
, union_bronze AS (
    ...
    event_name,
    event_id
    FROM applicationcreated_unnested_by_items_br
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_applications_order_details_br_logs
country: br
silver_table_name: f_applications_order_details_br_logs
