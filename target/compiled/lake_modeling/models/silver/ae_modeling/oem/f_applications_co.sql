...
, union_all_events AS (
    SELECT 
    ally_slug,application_channel_legacy,application_date,application_id,campaign_id,channel,client_id,client_is_transactional_based,client_type,custom_is_checkpoint_application_legacy,custom_is_preapproval_completed,custom_is_privacy_policy_accepted,custom_is_returning_client_legacy,custom_is_santander_branched,custom_platform_version,journey_name,ocurred_on,order_id,preapproval_amount,preapproval_expiration_date,product,requested_amount,requested_amount_without_discount,store_slug,store_user_id,store_user_name,event_name as last_event_name_processed,
    event_name,event_id as last_event_id_processed,
    event_id
    FROM union_bronze 
    UNION ALL
    SELECT 
    ally_slug,application_channel_legacy,application_date,application_id,campaign_id,channel,client_id,client_is_transactional_based,client_type,custom_is_checkpoint_application_legacy,custom_is_preapproval_completed,custom_is_privacy_policy_accepted,custom_is_returning_client_legacy,custom_is_santander_branched,custom_platform_version,journey_name,last_event_ocurred_on_processed as ocurred_on,order_id,preapproval_amount,preapproval_expiration_date,product,requested_amount,requested_amount_without_discount,store_slug,store_user_id,store_user_name,last_event_name_processed,
    event_name,last_event_id_processed,
    event_id
    FROM silver.f_applications_co  
    WHERE 
    silver.f_applications_co.application_id IN (SELECT DISTINCT application_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_applications_co
country: co
silver_table_name: f_applications_co
...
events_dict: {'allyapplicationupdated': {'direct_attributes': ['ally_slug', 'application_id', 'client_id', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'allyisdisabledtooriginateco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'allyisdisabledtooriginatepagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'applicationcreated': {'direct_attributes': ['ally_slug', 'application_date', 'application_id', 'channel', 'client_id', 'client_is_transactional_based', 'client_type', 'custom_platform_version', 'order_id', 'product', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'backgroundcheckpassedco': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'checkoutloginsentco': {'direct_attributes': ['application_id', 'ally_slug', 'channel', 'client_id', 'client_type', 'journey_name', 'product', 'ocurred_on'], 'custom_attributes': {}}, 'clientloanapplicationcreated': {'direct_attributes': ['ally_slug', 'application_date', 'application_id', 'client_id', 'custom_is_returning_client_legacy', 'custom_platform_version', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'clientpreapprovaljourneyisdisabledpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'clientwaspreapprovedbeforepagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'creditcheckapprovedsantanderco': {'direct_attributes': ['application_id', 'custom_is_santander_branched', 'ocurred_on'], 'custom_attributes': {}}, 'leaddisabledtooriginateco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'leaddisabledtooriginatepagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'loanproposalselectedco': {'direct_attributes': ['application_id', 'campaign_id', 'ocurred_on'], 'custom_attributes': {}}, 'loanproposalselectedsantanderco': {'direct_attributes': ['application_id', 'campaign_id', 'custom_is_santander_branched', 'ocurred_on'], 'custom_attributes': {}}, 'preapprovalapplicationcompletedco': {'direct_attributes': ['application_id', 'custom_is_preapproval_completed', 'preapproval_amount', 'preapproval_expiration_date', 'ocurred_on'], 'custom_attributes': {}}, 'preconditionswerevalidco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'preconditionswerevalidpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyaccepted': {'direct_attributes': ['application_date', 'application_id', 'client_id', 'custom_is_privacy_policy_accepted', 'requested_amount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyacceptedco': {'direct_attributes': ['application_id', 'campaign_id', 'client_id', 'custom_is_privacy_policy_accepted', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicyacceptedsantanderco': {'direct_attributes': ['application_id', 'ally_slug', 'campaign_id', 'client_id', 'ocurred_on'], 'custom_attributes': {}}, 'privacypolicysent': {'direct_attributes': ['ally_slug', 'application_date', 'application_id', 'client_id', 'custom_platform_version', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'prospectapplicationpreapproved': {'direct_attributes': ['application_id', 'custom_is_preapproval_completed', 'preapproval_amount', 'preapproval_expiration_date', 'ocurred_on'], 'custom_attributes': {}}, 'prospectloanapplicationcreatedfromcheckpoint': {'direct_attributes': ['ally_slug', 'application_channel_legacy', 'application_date', 'application_id', 'client_id', 'custom_is_checkpoint_application_legacy', 'custom_is_preapproval_completed', 'custom_platform_version', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'prospectloanapplicationcreatedv2': {'direct_attributes': ['ally_slug', 'application_channel_legacy', 'application_date', 'application_id', 'client_id', 'custom_platform_version', 'order_id', 'requested_amount', 'requested_amount_without_discount', 'store_slug', 'store_user_id', 'store_user_name', 'ocurred_on'], 'custom_attributes': {}}, 'prospectupgradedtoclient': {'direct_attributes': ['application_id', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwasgreaterthanmaximumconfiguredco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwasgreaterthanmaximumconfiguredpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwaslessthanminimumconfiguredco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'requestedamountwaslessthanminimumconfiguredpagoco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'returningclientjourneyisdisableco': {'direct_attributes': ['application_id', 'ally_slug', 'client_id', 'journey_name', 'ocurred_on'], 'custom_attributes': {}}, 'backgroundcheckpassed': {'direct_attributes': ['application_id', 'store_user_id', 'ocurred_on'], 'custom_attributes': {}}}
