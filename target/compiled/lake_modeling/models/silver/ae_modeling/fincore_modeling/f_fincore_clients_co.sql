...
, union_all_events AS (
    ...
    event_id
    FROM silver.f_fincore_clients_co  
    WHERE 
    silver.f_fincore_clients_co.client_id IN (SELECT DISTINCT client_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_fincore_clients_co
country: co
silver_table_name: f_fincore_clients_co
