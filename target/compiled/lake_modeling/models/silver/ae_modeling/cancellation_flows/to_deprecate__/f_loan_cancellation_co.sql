...
this: silver.f_loan_cancellation_co
country: co
silver_table_name: f_loan_cancellation_co
...
events_dict: {'LoanCancellationOrderProcessedV2': {'stage': 'legacy_or_non_origination', 'direct_attributes': ['loan_id', 'client_id', 'cancellation_reason', 'ocurred_on', 'cancellation_date', 'cancellation_id'], 'custom_attributes': {}}, 'LoanCancellationOrderAnnulledV2': {'stage': 'legacy_or_non_origination', 'direct_attributes': ['loan_id', 'client_id', 'annulment_reason', 'ocurred_on', 'cancellation_id'], 'custom_attributes': {}}}
