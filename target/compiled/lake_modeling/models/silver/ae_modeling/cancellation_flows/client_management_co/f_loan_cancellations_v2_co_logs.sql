...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_loan_cancellations_v2_co_logs
country: co
silver_table_name: f_loan_cancellations_v2_co_logs
...
events_dict: {'loancancellationorderprocessed': {'direct_attributes': ['event_id', 'loan_id', 'ally_slug', 'client_id', 'user_id', 'loan_cancellation_id', 'loan_cancellation_reason', 'loan_cancellation_order_date', 'loan_approved_amount', 'loan_origination_date', 'custom_event_domain', 'custom_loan_cancellation_status', 'ocurred_on'], 'custom_attributes': {}}, 'loancancellationorderprocessedv2': {'direct_attributes': ['event_id', 'loan_id', 'ally_slug', 'client_id', 'user_id', 'loan_cancellation_id', 'loan_cancellation_amount', 'loan_cancellation_type', 'loan_cancellation_reason', 'loan_cancellation_order_date', 'loan_approved_amount', 'loan_origination_date', 'user_role', 'store_user_name', 'custom_event_domain', 'custom_loan_cancellation_status', 'ocurred_on'], 'custom_attributes': {}}, 'loancancellationorderannulledv2': {'direct_attributes': ['event_id', 'loan_id', 'client_id', 'user_id', 'loan_cancellation_annulment_reason', 'loan_cancellation_id', 'custom_event_domain', 'custom_loan_cancellation_status', 'ocurred_on'], 'custom_attributes': {}}}
