...
, union_all_events AS (
    ...
    event_id
    FROM silver.f_transaction_cancellations_co  
    WHERE 
    silver.f_transaction_cancellations_co.transaction_id IN (SELECT DISTINCT transaction_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_transaction_cancellations_co
country: co
silver_table_name: f_transaction_cancellations_co
