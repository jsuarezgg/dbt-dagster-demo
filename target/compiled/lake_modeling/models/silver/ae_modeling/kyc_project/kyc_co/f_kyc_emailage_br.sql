...
WITH
emailageobtained_br AS ( 
    SELECT *
    FROM bronze.emailageobtained_br
...
, union_all_events AS (
    ...
    event_id
    FROM silver.f_kyc_emailage_br  
    WHERE 
    silver.f_kyc_emailage_br.application_id IN (SELECT DISTINCT application_id FROM union_bronze)      
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_kyc_emailage_br
country: br
silver_table_name: f_kyc_emailage_br
