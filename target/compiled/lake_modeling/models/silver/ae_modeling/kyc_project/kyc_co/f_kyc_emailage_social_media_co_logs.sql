...
WITH
emailageobtained_unnested_by_social_media_co AS ( 
    SELECT *
    FROM bronze.emailageobtained_unnested_by_social_media_co
...
, union_bronze AS (
    ...
    event_name,
    event_id
    FROM emailageobtained_unnested_by_social_media_co
...
/* DEBUGGING SECTION
is_incremental: True
this: silver.f_kyc_emailage_social_media_co_logs
country: co
silver_table_name: f_kyc_emailage_social_media_co_logs
