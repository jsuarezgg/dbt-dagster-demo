...
SELECT
    ...
    properties_hubspot_owner_id AS deal_owner_id,
    ...
    concat(concat(o2.firstName,' '),o2.lastName) activation_owner,
    concat(concat(o3.firstName,' '),o3.lastName) deal_owner,
    ...
    LEFT JOIN bronze.hubspot_owners_all o2
        ON deals.properties_owner_activacion=o2.id

    LEFT JOIN bronze.hubspot_owners_all o3
        ON deals.properties_hubspot_owner_id=o3.id