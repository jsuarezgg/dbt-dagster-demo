...
--raw_modeling.conditionalcreditcheckpassedwithlowerapprovedamountpagoco_co
SELECT
    -- MANDATORY FIELDS
...
from {{ source('raw_modeling', 'conditionalcreditcheckpassedwithlowerapprovedamountpagoco_co') }}
