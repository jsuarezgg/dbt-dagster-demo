...
--raw_modeling.identityphotosthirdpartyevaluationstarted
SELECT
    -- MANDATORY FIELDS
    ...
    coalesce(json_tmp.identityVerification.isHighRisk,
             json_tmp.creditCheck.isHighRisk) as is_high_risk,
    ...
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartyevaluationstarted_at
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identityphotosthirdpartyevaluationstarted') }}
