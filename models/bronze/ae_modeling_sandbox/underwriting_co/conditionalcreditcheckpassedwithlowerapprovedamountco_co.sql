...
--raw_modeling.conditionalcreditcheckpassedwithlowerapprovedamountco_co
SELECT
    -- MANDATORY FIELDS
...
from {{ source('raw_modeling', 'conditionalcreditcheckpassedwithlowerapprovedamountco_co') }}
