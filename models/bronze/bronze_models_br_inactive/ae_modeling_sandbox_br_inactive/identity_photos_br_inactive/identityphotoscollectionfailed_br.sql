...
--raw_modeling.identityphotoscollectionfailed_br
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.ocurredOn as identityphotoscollectionfailed_at,
...
from {{ source('raw_modeling', 'identityphotoscollectionfailed_br') }}
