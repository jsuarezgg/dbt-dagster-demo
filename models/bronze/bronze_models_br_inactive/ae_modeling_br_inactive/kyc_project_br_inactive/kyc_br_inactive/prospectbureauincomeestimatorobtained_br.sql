...
--raw_modeling.prospectbureauincomeestimatorobtained_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS prospectbureauincomeestimatorobtained_br_at -- To store it as a standalone column, when needed
FROM  {{source(  'raw_modeling', 'prospectbureauincomeestimatorobtained_br' )}}
