...
--raw_modeling.conditionalcreditcheckpassed_br
SELECT
    -- MANDATORY FIELDS
    ...
    /*coalesce(json_tmp.creditCheck.income.validator.calculationMethod.value,
    ...
    COALESCE(json_tmp.creditCheck.creditScore, json_tmp.creditCheck.creditScoreV2.value.value) as credit_score
    -- CUSTOM ATTRIBUTES
      -- Fill with your custom attributes
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'conditionalcreditcheckpassed_br') }}
