...
--raw_modeling.backgroundcheckpassed_br
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.application.applicationId.id AS application_id,
    json_tmp.application.prospect.id.id AS client_id,
    COALESCE(json_tmp.metadata.context.userId, json_tmp.metadata.context.storeUserId) AS store_user_id
    -- CUSTOM ATTRIBUTES

-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'backgroundcheckpassed_br') }}
