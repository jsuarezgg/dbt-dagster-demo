...
--raw_modeling.applicationapproved_br
SELECT
    -- MANDATORY FIELDS
    ...
    COALESCE(json_tmp.ally.slug,json_tmp.metadata.context.allyId) AS ally_slug, -- alternative: json_tmp.metadata.context.allyId
    ...
    -- CUSTOM ATTRIBUTES
    'APPROVED' AS termination_event_custom_name
-- DBT SOURCE REFERENCE
FROM {{ source('raw_modeling', 'applicationapproved_br') }}
