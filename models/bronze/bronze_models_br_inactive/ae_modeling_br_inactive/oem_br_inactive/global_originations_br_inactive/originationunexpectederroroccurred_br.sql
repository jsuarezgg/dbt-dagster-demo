...
--raw_modeling.originationunexpectederroroccurred_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CUSTOM ATTRIBUTES
    'UNEXPECTED_ERROR_OCCURRED' AS termination_event_custom_name
-- DBT SOURCE REFERENCE
FROM {{ source('raw_modeling', 'originationunexpectederroroccurred_br') }}
