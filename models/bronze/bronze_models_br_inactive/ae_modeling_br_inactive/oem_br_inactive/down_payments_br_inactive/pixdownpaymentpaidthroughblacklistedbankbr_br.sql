...
--raw_modeling.pixdownpaymentpaidthroughblacklistedbankbr_br
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.application.downPayment.wasPaidThroughBlacklistedBank as dp_paid_blb,
    json_tmp.application.downPayment.number as downpayment_number
    -- CUSTOM ATTRIBUTES
      -- Fill with your custom attributes
    -- CAST(ocurred_on AS TIMESTAMP) AS pixdownpaymentpaidthroughblacklistedbankbr_br_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'pixdownpaymentpaidthroughblacklistedbankbr_br') }}
