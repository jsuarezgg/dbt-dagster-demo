...
--raw_modeling.cellphonevalidationmaxattemptsreachedbr_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS cellphonevalidationmaxattemptsreachedbr_br_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'cellphonevalidationmaxattemptsreachedbr_br') }}
