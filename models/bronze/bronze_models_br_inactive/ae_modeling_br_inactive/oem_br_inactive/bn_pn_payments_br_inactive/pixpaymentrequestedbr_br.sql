...
--raw_modeling.pixpaymentrequestedbr_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CUSTOM ATTRIBUTES
    CAST(true AS BOOLEAN) AS custom_is_bnpn_branched
    -- CAST(ocurred_on AS TIMESTAMP) AS pixpaymentrequestedbr_br_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'pixpaymentrequestedbr_br') }}
