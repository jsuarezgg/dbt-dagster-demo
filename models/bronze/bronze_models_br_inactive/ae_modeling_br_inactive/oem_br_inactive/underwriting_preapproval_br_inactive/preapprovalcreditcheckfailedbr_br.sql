...
--raw_modeling.preapprovalcreditcheckfailedbr_br
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.creditCheck.score.name as credit_score_name, -- scorev2 is a string
    json_tmp.creditCheck.score.name as credit_score_product,
...
from {{ source('raw_modeling', 'preapprovalcreditcheckfailedbr_br') }}
