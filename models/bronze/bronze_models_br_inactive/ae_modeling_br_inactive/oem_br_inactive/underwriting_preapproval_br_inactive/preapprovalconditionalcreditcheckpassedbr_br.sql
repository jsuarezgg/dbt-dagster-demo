...
--raw_modeling.preapprovalconditionalcreditcheckpassedbr_br
SELECT
    -- MANDATORY FIELDS
    ...
    /* coalesce(json_tmp.creditCheck.scoreV2.pdCalculationMethod,
             json_tmp.creditCheck.score.pdCalculationMethod) as pd_calculation_method, */ -- scorev2 is a string
    /* coalesce(json_tmp.creditCheck.scoreV2.addiProbabilityDefault,
             json_tmp.creditCheck.score.addiProbabilityDefault) as probability_default_addi, */ -- scorev2 is a string
    /* coalesce(json_tmp.creditCheck.scoreV2.probabilityDefault,
             json_tmp.creditCheck.score.probabilityDefault) as probability_default_bureau, */ -- scorev2 is a string
...
from {{ source('raw_modeling', 'preapprovalconditionalcreditcheckpassedbr_br') }}
