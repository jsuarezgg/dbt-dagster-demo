...
--raw_modeling.clientfailedtoobtainscoringbr_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- json_tmp.json_tmp.creditCheck.bypassRejectedReason as bypassed_reason
    -- CUSTOM ATTRIBUTES
      -- Fill with your custom attributes
    -- CAST(ocurred_on AS TIMESTAMP) AS clientfailedtoobtainscoringbr_br_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'clientfailedtoobtainscoringbr_br') }}
