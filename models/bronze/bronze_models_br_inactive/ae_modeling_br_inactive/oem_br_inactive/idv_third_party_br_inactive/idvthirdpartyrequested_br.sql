...
--raw_modeling.idvthirdpartyrequested_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CUSTOM ATTRIBUTES
    'REQUESTED' AS idv_tp_custom_last_status,
    CAST(json_tmp.ocurredOn AS TIMESTAMP) AS idvthirdpartyrequested_br_at
-- DBT SOURCE REFERENCE
FROM {{ source('raw_modeling', 'idvthirdpartyrequested_br') }}
