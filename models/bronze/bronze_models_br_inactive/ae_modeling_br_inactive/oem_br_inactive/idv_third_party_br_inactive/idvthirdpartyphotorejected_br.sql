...
--raw_modeling.idvthirdpartyphotorejected_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CUSTOM ATTRIBUTES
    'PHOTO_REJECTED' AS idv_tp_custom_last_status,
    CAST(json_tmp.ocurredOn AS TIMESTAMP) AS idvthirdpartyphotorejected_br_at
-- DBT SOURCE REFERENCE
FROM {{ source('raw_modeling', 'idvthirdpartyphotorejected_br') }}
