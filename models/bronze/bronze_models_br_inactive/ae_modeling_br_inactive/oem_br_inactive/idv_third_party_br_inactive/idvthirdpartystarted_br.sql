...
--raw_modeling.idvthirdpartystarted_br
SELECT
    -- MANDATORY FIELDS
...
--    json_tmp.idvThirdParty.integration.unico.tokenLocation AS idv_tp_token_location,
    ...
    -- CUSTOM ATTRIBUTES
    'STARTED' AS idv_tp_custom_last_status,
    CAST(json_tmp.ocurredOn AS TIMESTAMP) AS idvthirdpartystarted_br_at
-- DBT SOURCE REFERENCE
FROM {{ source('raw_modeling', 'idvthirdpartystarted_br') }}
