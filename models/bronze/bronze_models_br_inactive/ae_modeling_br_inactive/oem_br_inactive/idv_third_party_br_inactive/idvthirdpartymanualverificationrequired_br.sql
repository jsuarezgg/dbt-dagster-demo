...
--raw_modeling.idvthirdpartymanualverificationrequired_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CUSTOM ATTRIBUTES
    'MANUAL_VERIFICATION_REQUIRED' AS idv_tp_custom_last_status,
    CAST(json_tmp.ocurredOn AS TIMESTAMP) AS idvthirdpartymanualverificationrequired_br_at
-- DBT SOURCE REFERENCE
FROM {{ source('raw_modeling', 'idvthirdpartymanualverificationrequired_br') }}
