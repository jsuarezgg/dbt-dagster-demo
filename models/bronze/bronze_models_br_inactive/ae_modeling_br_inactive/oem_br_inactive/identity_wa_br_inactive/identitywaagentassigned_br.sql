...
--raw_modeling.identitywaagentassigned_br
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.identityVerification.initialMessage.provider as idv_provider,
    -- CUSTOM ATTRIBUTES
    'V2' as custom_idv_version,
    CAST(ocurred_on AS TIMESTAMP) AS identitywaagentassigned_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identitywaagentassigned_br') }}
