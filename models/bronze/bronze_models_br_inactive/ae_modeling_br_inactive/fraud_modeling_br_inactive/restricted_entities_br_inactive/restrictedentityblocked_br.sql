...
--raw_modeling.restrictedentityblocked_br
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS restrictedentityblocked_br -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'restrictedentityblocked_br') }}
