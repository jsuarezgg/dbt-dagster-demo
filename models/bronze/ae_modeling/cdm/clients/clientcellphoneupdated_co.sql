...
--raw_modeling.ClientCellPhoneUpdated_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.client.id.id AS client_id,
    json_tmp.newCellPhone.value AS new_cellphone
FROM  {{ source('raw_modeling', 'clientcellphoneupdated_co') }}
