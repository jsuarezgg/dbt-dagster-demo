...
--raw_modeling.creditcheckfailed_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.income.validator.calculationMethod.value as credit_check_income_validator_calculation_method,
    ...
    /*coalesce(json_tmp.creditCheck.creditScoreV2.pdCalculationMethod.value,
...
from {{ source('raw_modeling', 'creditcheckfailed_co') }}
