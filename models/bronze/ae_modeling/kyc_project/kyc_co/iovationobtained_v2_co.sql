...
--raw_modeling.iovationobtained_v2_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS iovationobtained_v2_co_at -- To store it as a standalone column, when needed
FROM  {{source('raw_modeling', 'iovationobtained_v2_co' )}}
