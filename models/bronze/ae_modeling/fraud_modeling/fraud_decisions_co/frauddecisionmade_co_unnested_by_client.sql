...
WITH explode_clients as (SELECT
    -- MANDATORY FIELDS
    ...
    explode(json_tmp.fraudDecision.clients) AS clients
...
SELECT
    CONCAT('EID_', event_id, '_CLIID_', clients.id) AS surrogate_key,
    -- MANDATORY FIELDS
    event_name_original,
    event_name,
    event_id,
