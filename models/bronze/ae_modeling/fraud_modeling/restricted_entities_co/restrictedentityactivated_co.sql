...
--raw_modeling.restrictedentityactivated_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS restrictedentityactivated_co -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'restrictedentityactivated_co') }}
