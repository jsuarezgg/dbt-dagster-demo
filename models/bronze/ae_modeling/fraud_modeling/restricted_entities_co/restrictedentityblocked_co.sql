...
--raw_modeling.restrictedentityblocked_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS restrictedentityblocked_co -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'restrictedentityblocked_co') }}
