...
--addi_prod.raw.braze_users_messages_sms_deliveryfailure
SELECT
    -- MANDATORY FIELDS
    ...
    'DELIVERY_FAILURE' AS custom_message_status
-- DBT SOURCE REFERENCE
FROM {{ source('raw', 'braze_users_messages_sms_deliveryfailure') }}
