...
--raw_modeling.identitywainitialmessageresponsereceived_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(ocurred_on AS TIMESTAMP) AS identitywainitialmessageresponsereceived_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identitywainitialmessageresponsereceived_co') }}
