...
--raw_modeling.identitywaapproved_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS idv_passed,
    CAST(ocurred_on AS TIMESTAMP) AS identitywaapproved_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identitywaapproved_co') }}
