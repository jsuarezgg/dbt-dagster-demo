...
SELECT
    ...
    --json_tmp.creditCheck.requestedAmount AS requested_amount,
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS loanrefinanceproposalscreatedco_co_at -- To store it as a standalone column, when needed
