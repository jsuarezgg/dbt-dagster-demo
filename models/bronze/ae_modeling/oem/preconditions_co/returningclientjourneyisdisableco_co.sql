...
--raw_modeling.returningclientjourneyisdisableco_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS returningclientjourneyisdisableco_co -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'returningclientjourneyisdisableco_co') }}
