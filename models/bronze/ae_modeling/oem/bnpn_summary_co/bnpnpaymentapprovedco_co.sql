...
SELECT
    ...
    json_tmp.application.product AS product_v2,
    json_tmp.application.fullPayment.pse.amount as pse_amount,
    json_tmp.payment.amount as payment_amount,
    json_tmp.ally.store.slug as store_slug,
    json_tmp.ally.store.user as store_user_id
    -- CUSTOM ATTRIBUTES
