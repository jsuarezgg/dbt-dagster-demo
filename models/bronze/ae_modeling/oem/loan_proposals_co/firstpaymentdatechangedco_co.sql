...
--raw_modeling.firstpaymentdatechangedco_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.loan.firstPaymentDate as first_payment_date,
    json_tmp.loan.id as loan_proposal_id,
...
from {{ source('raw_modeling', 'firstpaymentdatechangedco_co') }}
