...
--raw_modeling.clienthasfootprintfromblacklistedentityco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS identity_verification_failed
    -- CAST(ocurred_on AS TIMESTAMP) AS clienthasfootprintfromblacklistedentityco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'clienthasfootprintfromblacklistedentityco_co') }}
