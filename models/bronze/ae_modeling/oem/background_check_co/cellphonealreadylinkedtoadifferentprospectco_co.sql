...
--raw_modeling.cellphonealreadylinkedtoadifferentprospectco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS background_check_failed
    -- CAST(ocurred_on AS TIMESTAMP) AS cellphonealreadylinkedtoadifferentprospectco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'cellphonealreadylinkedtoadifferentprospectco_co') }}
