...
--raw_modeling.documentlistedinblacklistco_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS documentlistedinblacklistco_co_at -- To store it as a standalone column, when needed
    CAST(1 AS TINYINT) AS background_check_failed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'documentlistedinblacklistco_co') }}
