...
--raw_modeling.clientpaymentbehaviorvalidationapprovedpagoco_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.creditCheck.learningPopulation as learning_population,*/ -- Non-existant json_tmp.creditCheck
...
from {{ source('raw_modeling', 'clientpaymentbehaviorvalidationapprovedpagoco_co') }}
