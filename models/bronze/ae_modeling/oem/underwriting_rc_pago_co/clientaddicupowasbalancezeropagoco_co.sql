...
--raw_modeling.clientaddicupowasbalancezeropagoco_co
SELECT
    -- MANDATORY FIELDS
    ...
    cast(false as BOOLEAN) as loan_accepted
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'clientaddicupowasbalancezeropagoco_co') }}
