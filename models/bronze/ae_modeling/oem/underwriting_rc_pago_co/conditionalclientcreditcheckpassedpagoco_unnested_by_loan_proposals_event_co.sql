...
--raw_modeling.conditionalclientcreditcheckpassedpagoco_co
...
from {{ source('raw_modeling', 'conditionalclientcreditcheckpassedpagoco_co') }}
...
SELECT 
    ...
    loan_proposals_event.guarantee.provider as guarantee_provider,
