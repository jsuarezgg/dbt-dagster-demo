...
--raw_modeling.workinformationreceivedsantanderco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS work_information_santander_passed
    -- CAST(ocurred_on AS TIMESTAMP) AS workinformationreceivedsantanderco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'workinformationreceivedsantanderco_co') }}
