...
--raw_modeling.requestedamountwaslessthanminimumconfiguredpagoco_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS requestedamountwaslessthanminimumconfiguredpagoco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'requestedamountwaslessthanminimumconfiguredpagoco_co') }}
