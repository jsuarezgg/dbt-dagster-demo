...
--raw_modeling.getclientinformationfailedsantanderco_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- CAST(ocurred_on AS TIMESTAMP) AS getclientinformationfailedsantanderco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'getclientinformationfailedsantanderco_co') }}
