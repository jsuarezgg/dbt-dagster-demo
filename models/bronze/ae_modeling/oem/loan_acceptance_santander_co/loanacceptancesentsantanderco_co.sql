...
--raw_modeling.loanacceptancesentsantanderco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS loan_acceptance_sent_passed
    -- CAST(ocurred_on AS TIMESTAMP) AS loanacceptancesentsantanderco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'loanacceptancesentsantanderco_co') }}
