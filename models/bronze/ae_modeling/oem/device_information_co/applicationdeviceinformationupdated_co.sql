...
--raw_modeling.applicationdeviceinformationupdated_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.application.device.traceId device_id,
    ...
    json_tmp.application.device.userAgent AS user_agent
    -- CUSTOM ATTRIBUTES
      -- Fill with your custom attributes
    -- CAST(ocurred_on AS TIMESTAMP) AS applicationdeviceinformationupdated_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'applicationdeviceinformationupdated_co') }}
