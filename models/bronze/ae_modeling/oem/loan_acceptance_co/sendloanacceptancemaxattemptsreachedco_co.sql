...
--raw_modeling.sendloanacceptancemaxattemptsreachedco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS loan_acceptance_sent_failed
    -- CAST(ocurred_on AS TIMESTAMP) AS sendloanacceptancemaxattemptsreachedco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'sendloanacceptancemaxattemptsreachedco_co') }}
