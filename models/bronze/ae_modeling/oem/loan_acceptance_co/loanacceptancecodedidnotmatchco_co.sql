...
--raw_modeling.loanacceptancecodedidnotmatchco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(1 AS TINYINT) AS loan_acceptance_failed
    -- CAST(ocurred_on AS TIMESTAMP) AS loanacceptancecodedidnotmatchco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'loanacceptancecodedidnotmatchco_co') }}
