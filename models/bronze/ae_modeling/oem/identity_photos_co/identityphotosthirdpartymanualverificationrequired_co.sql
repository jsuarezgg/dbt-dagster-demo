...
--raw_modeling.identityphotosthirdpartymanualverificationrequired_co
SELECT
    -- MANDATORY FIELDS
    ...
    'MANUAL_VERIFICATION_REQUIRED' AS identity_photos_tp_custom_last_status,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartymanualverificationrequired_co_at,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartymanualverificationrequired_at
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identityphotosthirdpartymanualverificationrequired_co') }}
