...
--raw_modeling.identityphotosdiscardedbyrisk_co
SELECT
    -- MANDATORY FIELDS
    ...
    json_tmp.identityVerification.photoQuality as photo_quality,
    -- CUSTOM ATTRIBUTES
    'V4' as custom_idv_version,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosdiscardedbyrisk_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identityphotosdiscardedbyrisk_co') }}
