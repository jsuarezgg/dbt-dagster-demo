...
--raw_modeling.identityphotosthirdpartydiscarded_co
SELECT
    -- MANDATORY FIELDS
    ...
    'DISCARDED' AS identity_photos_tp_custom_last_status,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartydiscarded_co_at,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartydiscarded_at
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identityphotosthirdpartydiscarded_co') }}
