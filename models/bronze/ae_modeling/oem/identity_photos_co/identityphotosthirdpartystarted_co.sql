...
--raw_modeling.identityphotosthirdpartystarted_co
SELECT
    -- MANDATORY FIELDS
    ...
    'STARTED' AS identity_photos_tp_custom_last_status,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartystarted_co_at,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartystarted_at
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identityphotosthirdpartystarted_co') }}
