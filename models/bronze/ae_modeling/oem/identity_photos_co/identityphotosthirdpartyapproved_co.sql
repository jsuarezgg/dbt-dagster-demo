...
SELECT
    ...
    'APPROVED' AS identity_photos_tp_custom_last_status,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartyapproved_co_at,
    CAST(ocurred_on AS TIMESTAMP) AS identityphotosthirdpartyapproved_at
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'identityphotosthirdpartyapproved_co') }}
