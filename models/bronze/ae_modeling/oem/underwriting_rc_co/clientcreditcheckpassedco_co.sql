...
--raw_modeling.clientcreditcheckpassedco_co
SELECT
    -- MANDATORY FIELDS
...
-- MAPPED FIELDS - DIRECT ATTRIBUTES
    ...
    cast(json_tmp.creditCheck.shouldBeBlackListed as boolean) should_be_black_listed,
...
from {{ source('raw_modeling', 'clientcreditcheckpassedco_co') }}
