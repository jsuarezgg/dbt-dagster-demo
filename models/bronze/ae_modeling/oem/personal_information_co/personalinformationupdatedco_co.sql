...
--raw_modeling.personalinformationupdatedco_co
SELECT
    -- MANDATORY FIELDS
    ...
    CAST(json_tmp.client.birth.date AS DATE) AS birthday,
    json_tmp.client.gender AS gender
    -- CUSTOM ATTRIBUTES
      -- Fill with your custom attributes
    -- CAST(ocurred_on AS TIMESTAMP) AS personalinformationupdatedco_co_at -- To store it as a standalone column, when needed
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'personalinformationupdatedco_co') }}
