...
--raw_modeling.creditcheckapprovedsantanderco_co
SELECT
    -- MANDATORY FIELDS
    ...
    -- json_tmp.creditCheck.creditPolicy as credit_policy_name,
    --json_tmp.creditCheck.score as credit_score_name,
    ...
    json_tmp.application.funder AS funder,
    -- CUSTOM ATTRIBUTES
      -- Fill with your custom attributes
    cast(false as BOOLEAN) as returning_client,
    CAST(1 AS TINYINT) AS credit_check_passed,
    CAST(TRUE AS BOOLEAN) AS custom_is_santander_branched
-- DBT SOURCE REFERENCE
from {{ source('raw_modeling', 'creditcheckapprovedsantanderco_co') }}
