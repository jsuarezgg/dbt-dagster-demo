...
SELECT 
    ...
    loan.status.lateFees AS unpaid_collection_fees,
    loan.status.totalLateFeesPaid AS total_collection_fees_paid,
    loan.status.totalLateFeesCondoned AS total_collection_fees_condoned,
