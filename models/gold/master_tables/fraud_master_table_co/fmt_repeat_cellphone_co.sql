...
left join {{ ref('fmt_bureau_check_co') }} pd2 on pd1.application_cellphone = pd2.application_cellphone and pd1.client_id != pd2.client_id and pd1.application_date > pd2.application_date
