...
WITH data_with_array_struct AS (
    SELECT
        ...
        ARRAY(
            ...
            NAMED_STRUCT('stage','pre_udw_conversion','values',NAMED_STRUCT('in',1,'out',underwriting_br_in),'priority',1),
            NAMED_STRUCT('stage','post_udw_conversion','values',NAMED_STRUCT('in',underwriting_br_in,'out',flag_approval_event),'priority',2)
