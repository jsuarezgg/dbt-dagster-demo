...
left join {{ ref('fmt_bureau_check_br') }} pd2 on lower(pd1.application_email) = lower(pd2.application_email) and pd1.client_id != pd2.client_id and pd1.application_date > pd2.application_date
