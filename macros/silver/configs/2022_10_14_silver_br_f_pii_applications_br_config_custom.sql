{% macro return_config_br_f_pii_applications_br_custom() %}
{#-target_country=br;target_schema=silver;target_table_name=f_pii_applications_br-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2022-09-13 15:30 TZ-0500",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "br",
        "files_db_table_name": "f_pii_applications_br",
        "files_db_table_pks": [
            "application_id"
        ]
    },
