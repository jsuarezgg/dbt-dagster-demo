{% macro return_config_br_f_kyc_neuroid_v2_br_custom() %}
{#-target_country=br;target_schema=silver;target_table_name=f_kyc_neuroid_v2_br-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2022-12-05 15:00 TZ-0500",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "br",
        "files_db_table_name": "f_kyc_neuroid_v2_br",
        "files_db_table_pks": [
            "application_id"
        ]
    },
