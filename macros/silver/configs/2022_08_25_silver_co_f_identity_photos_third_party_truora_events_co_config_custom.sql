{% macro return_config_co_f_identity_photos_third_party_truora_events_co_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_identity_photos_third_party_truora_events_co-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2022-08-25 10:30 TZ-0500",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_identity_photos_third_party_truora_events_co",
        "files_db_table_pks": [
