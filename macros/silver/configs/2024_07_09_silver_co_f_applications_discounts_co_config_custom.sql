{% macro return_config_co_f_applications_discounts_co_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_applications_discounts_co-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-07-09 11:57 TZ-0600",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_applications_discounts_co",
        "files_db_table_pks": [
