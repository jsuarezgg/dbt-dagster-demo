{% macro return_config_co_f_transaction_cancellations_co_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_transaction_cancellations_co-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-04-08 14:43 TZ-0500",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_transaction_cancellations_co",
        "files_db_table_pks": [
            "transaction_id"
        ]
    },
