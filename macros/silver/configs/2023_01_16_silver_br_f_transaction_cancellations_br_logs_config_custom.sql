{% macro return_config_br_f_transaction_cancellations_br_logs_custom() %}
{#-target_country=br;target_schema=silver;target_table_name=f_transaction_cancellations_br_logs-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2023-01-18 12:01 TZ-0500",
    "is_group_feature_active": false,
    "relevant_properties": {
        "schema_country": "br",
        "files_db_table_name": "f_transaction_cancellations_br_logs",
        "files_db_table_pks": [
            "event_id"
        ]
    },
