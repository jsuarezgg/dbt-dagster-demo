{% macro return_config_co_f_fincore_loans_co_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_fincore_loans_co-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-05-07 10:34 TZ-0300",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_fincore_loans_co",
        "files_db_table_pks": [
            "loan_id"
        ]
    },
