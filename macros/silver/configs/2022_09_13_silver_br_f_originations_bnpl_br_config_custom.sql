{% macro return_config_br_f_originations_bnpl_br_custom() %}
{#-target_country=br;target_schema=silver;target_table_name=f_originations_bnpl_br-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2022-09-09 10:05 TZ-0300",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "br",
        "files_db_table_name": "f_originations_bnpl_br",
        "files_db_table_pks": [
            "application_id"
        ]
    },
