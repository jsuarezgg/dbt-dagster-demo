{% macro return_config_co_d_ally_slugs_co_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=d_ally_slugs_co-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2023-07-26 12:41 TZ-0500",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "d_ally_slugs_co",
        "files_db_table_pks": [
            "ally_slug"
        ]
    },
