{% macro return_config_co_f_applications_marketplace_suborders_items_co_logs_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_applications_marketplace_suborders_items_co_logs-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-03-07 17:07 TZ-0500",
    "is_group_feature_active": false,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_applications_marketplace_suborders_items_co_logs",
        "files_db_table_pks": [
            "custom_event_suborder_sku_pairing_id"
        ]
    },
    "events": {
