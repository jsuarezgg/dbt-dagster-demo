{% macro return_config_co_d_prospect_personal_data_co_logs_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=d_prospect_personal_data_co_logs-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-05-02 12:59 TZ-0300",
    "is_group_feature_active": false,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "d_prospect_personal_data_co_logs",
        "files_db_table_pks": [
            "event_id"
        ]
    },
