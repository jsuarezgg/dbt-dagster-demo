{% macro return_config_co_f_kyc_seon_fraud_co_logs_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_kyc_seon_fraud_co_logs-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-07-02 11:57 TZ-0600",
    "is_group_feature_active": false,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_kyc_seon_fraud_co_logs",
        "files_db_table_pks": [
            "event_id"
        ]
    },
