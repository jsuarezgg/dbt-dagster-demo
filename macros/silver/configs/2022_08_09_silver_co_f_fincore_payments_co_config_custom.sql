{% macro return_config_co_f_fincore_payments_co_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_fincore_payments_co-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2024-02-06 12:12 TZ-0600",
    "is_group_feature_active": true,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_fincore_payments_co",
        "files_db_table_pks": [
            "payment_id"
        ]
    },
