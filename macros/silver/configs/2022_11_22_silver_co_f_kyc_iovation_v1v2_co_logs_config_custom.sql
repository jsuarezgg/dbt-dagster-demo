{% macro return_config_co_f_kyc_iovation_v1v2_co_logs_custom() %}
{#-target_country=co;target_schema=silver;target_table_name=f_kyc_iovation_v1v2_co_logs-#}
{%- set configuration_dict = {
    "config_parser_execution_date": "2022-11-22 18:00 TZ-0500",
    "is_group_feature_active": false,
    "relevant_properties": {
        "schema_country": "co",
        "files_db_table_name": "f_kyc_iovation_v1v2_co_logs",
        "files_db_table_pks": [
            "event_id"
        ]
    },
